...
@BoxBIF( description = "Get the number of items in a list" )
...
public class ListLen extends BIF {
	 ...
	 *
	 * @argument.multiCharacterDelimiter boolean whether the entire string is treated as a single delimiter
	 */
